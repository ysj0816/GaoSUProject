...
public class SignNotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_not);
    ...
    private void initView() {
        ...
        webview.loadUrl("file:///android_asset/html/sign_not.html");
    ...
    @android.webkit.JavascriptInterface
    public String getIp() {
        String url = UrlConstant.formatUrl(UrlConstant.NOSIGNURL);
        return url;
    }
    @android.webkit.JavascriptInterface
