 ...
 * 个人考勤记录
 */
public class SignOnserlfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_onserlf);
    ...
    private void initView() {
        ...
        webview.loadUrl("file:///android_asset/html/sign_oneself.html");
    ...
    public String getDeleteIP() {
        String url = UrlConstant.formatUrl(UrlConstant.DELETESIGNURL);
        Log.i("test", "删除的url："+url);
        return url;
    }
    @android.webkit.JavascriptInterface
    public String getPath() {
        String url = UrlConstant.HTTP+UrlConstant.getIP()+":"+UrlConstant.getPORT();
        Log.i("test", "删除的url："+url);
        return url;
    }
