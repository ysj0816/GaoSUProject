...
public class PermissionsActivity extends Activity {
    ...
    /**
     * @Description TODO(设置任务栏透明)
     * @Detailed方法详述(简单方法可不必详述)
     * @Date 2015年11月17日 上午10:34:19
     */
    ...
    protected void onResume() {
        super.onResume();
        Log.i("test","是否需要权限检测："+isRequireCheck);
        if (isRequireCheck) {
            Log.i("test","检测："+isRequireCheck);
    ...
    private String[] getPermissions() {
        Log.i("test","请求权限："+getIntent().getStringArrayExtra(EXTRA_PERMISSIONS).length);
