...
import com.chuyu.gaosuproject.network.reponse.SimpleResponse;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (rawType == BaseResponse.class) {
            ...
            int code = baseResponse.getError_code();
            if (code == 0) {
                //noinspection unchecked
                ...
                throw new IllegalStateException("错误代码：" + code + "，错误信息：" + baseResponse.getReason());
            }
        }
