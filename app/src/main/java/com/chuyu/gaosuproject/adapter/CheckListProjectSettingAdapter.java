...
import com.chuyu.gaosuproject.bean.CheckListFill_CheckProject;
...
public class CheckListProjectSettingAdapter extends BaseAdapter {
    ...
    private int index = -1;
    private List<CheckListFill_CheckProject.CheckProject> Date;
    CheckListFill_CheckProject.CheckProject date;

    public CheckListProjectSettingAdapter(Context context, CheckListProjectSettingAdapter.OnItemClickListener setitemClickListener) {
    ...
    public void setList(List<CheckListFill_CheckProject.CheckProject> Date) {
        this.Date = Date;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        date = (CheckListFill_CheckProject.CheckProject) getItem(position);
        holder.radioBtn.setChecked(date.isSelected());
        holder.radioBtn.setText(date.getSubproject());
